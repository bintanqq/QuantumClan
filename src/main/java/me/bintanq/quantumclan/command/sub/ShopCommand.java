...
public class ShopCommand {
    ...
    public ShopCommand(QuantumClan plugin) { this.plugin = plugin; }
    public void execute(Player player, String[] args) {
        if (!player.hasPermission("quantumclan.shop.use")) { plugin.sendMessage(player, "error.no-permission"); return; }
